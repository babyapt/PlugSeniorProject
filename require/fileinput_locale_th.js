...
(function ($) {
    ...
    $.fn.fileinputLocales['th'] = {
        ...
        msgInvalidFileExtension: 'ไฟล์ "{name}" มีนามสกุลที่ไม่ถูกต้อง, อนุญาตเฉพาะไฟล์นามสกุล "{extensions}"',
        ...
        msgFoldersNotAllowed: 'ลากแล้ววางเฉพาะไฟล์เท่านั้น! ข้าม dropped folder จำนวน {n}',
